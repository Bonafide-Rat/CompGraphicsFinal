...
class FirstPersonCameraDemo {
    ...
    initializeRenderer_() {
        this.threejs_ = new THREE.WebGLRenderer({antialias: false});
    ...
    initializeScene_() {
        ...
        this.sprite_ = new THREE.Sprite(new THREE.SpriteMaterial({
            map: crosshair,
            color: 0xffffff,
            fog: false,
            depthTest: false,
    ...
    loadMaterial_(name, tiling) {
        ...
        const material = new THREE.MeshStandardMaterial({metalnessMap: metalMap, map: albedo, normalMap: normalMap, roughnessMap: roughnessMap});
